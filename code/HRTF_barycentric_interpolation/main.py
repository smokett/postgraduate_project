...
def main(mode, tag, using_hpc):
    ...
    if mode == 'generate_projection':
        ...
        train_hrtfs = torch.empty(size=(2*train_size, 5, 16, 16, 128))
        j = 0
        for i in range(len(ds)):
            ...
            print(clean_hrtf.shape)
            low_dir = "projected_data/low_5/"
            ...
            if ds[i]['group'] in train_sample:
                ...
                j += 1
                with open(low_dir + "ARI_" + subject_id + side, "wb") as file:
